...
| S5 | style | 预期差结构缺失或不可证伪：第 08 章缺市场隐含预期 / 我方预期 / 证据锚点 / 差异方向 / 验证日期 / 先行指标 / 上下行失效条件，或缺内在价值判断 / 1-3个月路径判断 / 研究动作三分法；第 00 / 09 章仅在结论锚点精确为观察池 / 进入深研时适用，其中第 00 章不要求三分法 |
...
- 对 rough 模式：`排除 / 信息不足` 结论不得因缺预期差框架判 S5；只有第 00 / 09 章结论锚点
