...
| `S5` | style | 预期差结构缺失或不可证伪；08 章缺市场隐含预期 / 我方预期 / 证据锚点 / 差异方向 / 验证日期 / 先行指标 / 上下行失效条件，或缺内在价值 / 1-3个月路径 / 研究动作三分法 | patch / regenerate |
...
| `S5` 预期差结构缺失 | 在既有证据内补齐；无独立观点则写"暂无可证伪预期差"并把研究动作降为"观察 / 继续验证" |
